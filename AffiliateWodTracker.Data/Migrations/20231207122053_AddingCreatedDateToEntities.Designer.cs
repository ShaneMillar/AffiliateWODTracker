...
namespace AffiliateWODTracker.Core.Migrations
{
    ...
    [Migration("20231207122053_AddingCreatedDateToEntities")]
    partial class AddingCreatedDateToEntities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AffiliateWODTracker.Data.DataModels.MemberEntity", b =>
                {
            ...
            modelBuilder.Entity("AffiliateWODTracker.Data.DataModels.OwnerEntity", b =>
                {
            ...
            modelBuilder.Entity("AffiliateWODTracker.Data.DataModels.StatusEntity", b =>
                {
                    b.Property<int>("StatusId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AffiliateWODTracker.Data.DataModels.WODEntity", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("WodId"));
            ...
            modelBuilder.Entity("AffiliateWODTracker.Data.DataModels.AffiliateEntity", b =>
                {
                    b.HasOne("AffiliateWODTracker.Data.DataModels.OwnerEntity", "Owner")
                        .WithMany()
            ...
            modelBuilder.Entity("AffiliateWODTracker.Data.DataModels.MemberEntity", b =>
                {
                    ...
                    b.HasOne("AffiliateWODTracker.Data.DataModels.StatusEntity", "Status")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("AffiliateWODTracker.Data.DataModels.OwnerEntity", null)
                        .WithMany()
